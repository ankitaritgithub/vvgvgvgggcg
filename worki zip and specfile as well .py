...
def upload_files_to_tests_folder(files: List[FileContent]) -> List[str]:
    ...
    For .spec.js files, saves them to ../GUIagentTask/Gui_agent_script/playwright_tests/tests.
    ...
    for file in files:
        try:
            ...
            # Handle spec.js file upload
                ...
                # Set the target folder to ../GUIagentTask/Gui_agent_script/playwright_tests/tests
                target_folder = os.path.join(base_tests_folder, 'playwright_tests', 'tests')
