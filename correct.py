...
def analyze_user_prompt(state: Dict[str, Any]) -> Dict[str, Any]:
    """Analyzes user prompt to identify relevant test files and command patterns and data generation."""
    try:
...
def run_playwright_tests(state: Dict[str, Any]) -> Dict[str, Any]:
    """Executes Playwright tests based on user prompt and selected files."""
